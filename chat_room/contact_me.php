...
<body>
 ...
 <?php
		...
		$response = mail("othman.elmzalni@gmail.com","New Contact Us Message",$content);

		if ($response === true) 
			{
			 echo "<div class='alert alert-success' role='alert'><strong>Thank You ! </strong>Message Was Sent.</div>";
			}
			
		else 
			{
    echo "<div class='alert alert-warning' role='alert'><strong>Fail ! </strong>Message Was Not Sent.</div>";
			}
    }
